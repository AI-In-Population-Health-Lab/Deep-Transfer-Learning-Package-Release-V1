...
learned_model_fold_loc ='/Users/yeye/Documents/CMU_course_project/Transfer-Learning/syntheticData_Exp_11082021_code_result/results/learned_model/dann_noTargetLabel/'
...
def main(args: argparse.Namespace):
    ...
    learned_tl_model_path = learned_model_fold_loc + args.source_train_path + "-" + args.target_train_path + "-" + str(args.seed) + "-dannNoTargetLabel.pth"
        ...
        for j in range(len(target_train_paths)):
            ...
            for i in range(len(source_train_paths)):
                ...
                for seed_index in range(len(seed_paths)):
                    ...
                    temp = args.source_train_path + "-" + args.target_train_path + "-" + str(args.seed) + "-dannNoTargetLabel.pth"
