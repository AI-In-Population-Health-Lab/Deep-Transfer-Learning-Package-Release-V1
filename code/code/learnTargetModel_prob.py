...
def main(args: argparse.Namespace):
    ...
    learned_target_model_path = learned_model_fold_loc  + args.target_train_path  + "_" + str(args.seed) + ".pth"
    csvFilename = prob_fold_loc + "target_model_prob_" + args.target_train_path + "_" + str(args.seed) + ".csv"
    ...
    with open(results_fold_loc + "/auc_targetModel_log11202021.txt", "w") as f:
        ...
        for i in range(len(target_train_paths)):
            ...
            for seed_index in range(len(seed_paths)):
                ...
                f.write(
                    f"{args.target_train_path},{seed_index},{args.seed},{test_acc1},{avg_auc},{auc_I},{auc_M},{auc_P},{auc_R}\n")
