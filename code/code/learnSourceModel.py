...
def main(args: argparse.Namespace):
    ...
    train_source_loader = DataLoader(source_train_dataset, batch_size=args.batch_size, shuffle=True,
                                     num_workers=args.workers, drop_last=True)
    val_loader = DataLoader(source_val_dataset, batch_size=args.batch_size, shuffle=False,
    ...
    for epoch in range(args.epochs):
        ...
        if acc1 > best_acc1:
            ...
            torch.save(classifier.state_dict(), learned_source_model_path) # newly added to save the best models
            best_acc1 = acc1
    ...
    with open(results_fold_loc + "/sourceModel_log11202021.txt", "w") as f:
        ...
        for i in range(len(source_train_paths)):
            ...
            for seed_index in range(len(seed_paths)):
                ...
                f.write(
                    f"{d_kl},{args.source_train_path},{seed_index},{args.seed},{validate_acc},{test_acc}\n")
                print(
                    f"{d_kl},{args.source_train_path},{seed_index},{args.seed},{validate_acc},{test_acc}\n")
