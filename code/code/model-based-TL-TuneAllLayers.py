        ...
        with open(results_fold_loc+"/model_tuneAll" + size + ".txt", "w") as f:
            ...
            for i in range(len(source_train_paths)):
                ...
                for seed_index in range(len(seed_paths)):
                    ...
                    f.write(f"{d_kl},{args.source_train_path},{args.source_seed},{args.target_train_path},{args.seed},{best_acc1},{test_acc}\n")
                    print(f"{d_kl},{args.source_train_path},{args.source_seed},{args.target_train_path},{args.seed},{best_acc1},{test_acc}\n")
